      ...
      <div class="report-main">
        ...
        <div class="report-content">
          ...
          <div class="report-nav report-nav-left">
            <div><img src="./assets/tishi.png" class="tishi-icon"/>平安颖像肺结节智能筛查系统提示：通过对您病区患者的肺结节影像智能筛查，筛查状况见下表，此提示仅供您参考，请进一步诊断确认！</div>
          </div>
          <div class="report-des">
            ...
            <div class="report-main-right">
              ...
              <div class="ct-button">
                <el-button type="success" class="ct-button-1" @click="$router.push({path:'fjjCT',query:$route.query})">查看影像</el-button>
